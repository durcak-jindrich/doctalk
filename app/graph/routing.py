...
Deliberately a regex, not an LLM classifier. The cost is recall — an unusual
phrasing of "summarize" falls through to retrieval, which still answers, just
from relevance-ranked chunks instead of document openings. That is the safe
